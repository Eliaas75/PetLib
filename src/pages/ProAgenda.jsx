    ...
    <div className="max-w-[1200px] mx-auto px-6 lg:px-20 py-8">
      ...
      <div className="mt-6 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-muted">Consulte les patients attendus, le motif et l’origine du rendez-vous.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="divide-y divide-border">
            {visibleAppointments.map((appointment) => (
              <div key={appointment._id} className="py-4 first:pt-0 last:pb-0 grid grid-cols-[70px_1fr] md:grid-cols-[80px_1fr_auto] gap-4 items-start md:items-center">
                ...
                <div className="text-sm text-muted md:text-right">jusqu’à {formatTime(appointment.endsAt)}</div>
              </div>
            ))}
          </div>
        ) : (
